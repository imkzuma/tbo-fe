...
export default function headerApp(){
    return(
        <Container fluid className = 'h-[50vh] d-flex justify-content-center align-items-center text-center bg-primary md:rounded-b-full'>
            <Container className = 'pb-14'>
                <div>
                    <h1 className = 'text-5xl text-white font-bold'>Project Akhir TBO</h1>
                    <Col lg = {6} className = 'm-auto'>
                    <p className = 'pt-3 text-gray-100 font-light text-lg'>
